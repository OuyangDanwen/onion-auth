...
public class PeerOnionAuth {
	...
	//open an server socket, listening for incoming connection
	...
	//generate a RSA public-private key pair with key length of 4096 bits
	...
	//generate the session key as a common secret using the Diffie Hellman method
	...
	//encrypt the payload with a random IV in GCM mode
	...
	//decrypt the encrypted payload with a given IV in GCM mode
	...
	//layer decrypt the encrypted payload

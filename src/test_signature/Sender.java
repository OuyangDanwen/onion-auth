...
public class Sender {
	...
	private void extractDataFromMessage() throws Exception {
		int a = dhPubKey.getEncoded().length; // used as reference for the length - this throws an exception sometimes, when the received DH pub key is 1 byte shorter than the party's DH pub key 
